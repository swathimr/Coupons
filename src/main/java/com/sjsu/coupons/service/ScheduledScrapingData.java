...
public class ScheduledScrapingData {
	 ...
	 private  String readAll(Reader rd) throws IOException {
		  ...
		  public  void addWalmartCoupons() throws IOException, JSONException
		  {
		...
		private  void insertIntoDB(String shopname, String couponname, String coupondesc,
				String coupon_image_url, String coupon_value) {
			System.out.println(shopname + "\t" + couponname + "\t" + coupondesc + "\t" + coupon_image_url + "\t" + coupon_value + "/n");
		}

		public  void addTargetCoupons() throws IOException, JSONException
		  {
		...
		public  void addMacysCoupons() throws IOException, JSONException
		{
		  ...
		  public  void addKohlsCoupons() throws IOException, JSONException
		  {
		  ...
		  public  void addStaplesCoupons() throws IOException, JSONException
		  {
